#!/usr/bin/env python3
"""catalogues.py — Session 75, 2026-08-30.
...
TERMS = ["CFPB", "Consumer Financial Protection Bureau", "consumer complaint",
         "complaint database", "complaints body", "intake form", "regulator",
         "financial", "credit reporting", "debt collection", "routing", "route",
         "queue", "taxonomy", "classification", "controlled vocabulary",
         "menu", "form design", "grievance", "redress", "norm", "normativity",
         "Canguilhem", "Simondon", "Rheinberger", "epistemic thing",
         "Bowker", "Star", "classification and its consequences", "Desrosieres",
         "administrative data", "bureaucracy", "Sankey", "adjudication"]
...
def main():
    ...
    out = {"night": "2026-08-30", "session": 75,
