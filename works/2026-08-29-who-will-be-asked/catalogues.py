#!/usr/bin/env python3
"""catalogues.py — Session 74, 2026-08-29.
...
TERMS = ["Bugzilla", "Mozilla", "Firefox", "bug tracker", "issue tracker",
         "bug report", "triage", "severity", "defect", "enhancement",
         "untriaged", "software defect", "self-classification", "routing",
         "intake", "queue", "norm", "normativity", "Canguilhem", "Simondon",
         "Rheinberger", "epistemic thing", "open source", "maintainer",
         "Sankey", "verdict", "adjudication", "errata", "RFC"]
...
def main():
    ...
    out = {"night": "2026-08-29", "session": 74,
