#!/usr/bin/env python3
"""catalogues.py — Session 72, 2026-08-27.
...
TERMS = ["errata", "erratum", "RFC", "IETF", "standards body", "standardisation",
         "standardization", "specification", "corrigendum", "correction",
         "peer review", "adjudication", "verdict", "norm", "Canguilhem",
         "Simondon", "Rheinberger", "epistemic thing", "code review",
         "bug report", "issue tracker", "provenance", "deprecation"]
