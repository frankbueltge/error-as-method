#!/usr/bin/env python3
"""catalogues.py — Session 76, 2026-08-31.
...
UA = "error-as-method/night-2026-08-31 (research; contact f.bueltge@gmail.com)"
FEEDS = {
...
TERMS = ["GBIF", "Global Biodiversity Information Facility", "biodiversity",
         "occurrence record", "data registry", "basis of record", "Darwin Core",
         "validation", "data quality flag", "interpretation", "indexing pipeline",
         "controlled vocabulary", "classification", "taxonomy", "specimen",
         "natural history collection", "herbarium", "museum", "citizen science",
         "observation", "provenance", "metadata standard", "norm", "normativity",
         "Canguilhem", "Simondon", "Rheinberger", "epistemic thing",
         "Bowker", "Star", "classification and its consequences", "Desrosieres",
         "infrastructure", "residual category", "other", "error"]
...
def main():
    ...
    out = {"night": "2026-08-31", "session": 76,
