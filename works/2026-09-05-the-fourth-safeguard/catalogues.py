#!/usr/bin/env python3
"""catalogues.py — Session 81, 2026-09-05.
...
recorded, per Session 70's open thread 5 and Session 71's answer to it. Term list revised for tonight's object: a regulation's two halves, and the
vocabulary Session 80 discovered this line had been missing.
...
UA = "error-as-method/night-2026-09-05 (research; contact f.bueltge@gmail.com)"
FEEDS = {
...
TERMS = ["GDPR", "General Data Protection Regulation", "recital", "preamble",
         "regulation", "legislation", "statute", "legal text", "law",
         "contestability", "right to explanation", "explainability",
         "automated decision", "profiling", "data protection", "privacy",
         "soft law", "non-binding", "binding", "enforcement",
         "European Union", "Court of Justice", "case law", "jurisprudence",
         "norm", "normativity", "Canguilhem", "Simondon", "Rheinberger",
         "epistemic thing", "Bowker", "Star", "Desrosieres", "infrastructure",
         "classification", "taxonomy", "error", "corpus linguistics", "text analysis"]
...
def main():
    ...
    out = {"night": "2026-09-05", "session": 81,
