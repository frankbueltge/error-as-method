...
PROBES = ["obligation extraction", "deontic", "normative requirement", "inter-annotator",
          "Cohen's kappa", "kappa", "rule-based", "legal NLP", "requirements engineering",
          "passive voice", "agent deletion", "RFC 2119"]


def main():
    out = {"_what": "The house catalogues as they stood on 2026-09-21, consulted before this "
