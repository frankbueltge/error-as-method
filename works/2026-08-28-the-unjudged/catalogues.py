#!/usr/bin/env python3
"""catalogues.py — Session 73, 2026-08-28.
...
TERMS = ["errata", "erratum", "RFC", "IETF", "triage", "backlog", "queue",
         "survival analysis", "Kaplan-Meier", "censoring", "waiting time",
         "routing", "intake", "classification", "self-report", "severity",
         "adjudication", "verdict", "norm", "normativity", "Canguilhem",
         "Simondon", "Rheinberger", "epistemic thing", "the normal and the pathological",
         "bug report", "issue tracker", "unresolved"]
...
def main():
    ...
    out = {"note": "Counts only. The feeds are read, never mirrored.", "feeds": {}}
